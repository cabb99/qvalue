...
html_logo = "_static/logo/mdakits-qvalue-logo.png"
html_favicon = "_static/logo/mdakits-qvalue-favicon.svg"
...
latex_documents = [
    (master_doc, "qvalue.tex", "Qvalue Documentation",
     "qvalue", "manual"),
]
