...
We welcome all contributions to Qvalue!

Contributions can take many forms, such as:

* sharing bug reports or feature requests through the [Issue Tracker](https://github.com/cabb99/qvalue/issues)
...
The second two options both involve making a [pull request](https://github.com/cabb99/qvalue/pulls) .
